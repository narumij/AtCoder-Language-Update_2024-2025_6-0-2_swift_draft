...
swiftc \
    ...
    -emit-dependencies \
    -emit-module \
    -emit-module-path ${PACKAGE_PATH}/.build/x86_64-unknown-linux-gnu/release/Modules/Main.swiftmodule \
    -output-file-map ${PACKAGE_PATH}/.build/x86_64-unknown-linux-gnu/release/Main.build/output-file-map.json \
    -whole-module-optimization \
    -num-threads 1 \
    -c @${PACKAGE_PATH}/.build/x86_64-unknown-linux-gnu/release/Main.build/sources \
    -I ${PACKAGE_PATH}/.build/x86_64-unknown-linux-gnu/release/Modules \
    -target x86_64-unknown-linux-gnu \
    -O \
    -j1 \
    -DSWIFT_PACKAGE \
    -Xcc -fmodule-map-file=${PACKAGE_PATH}/.build/checkouts/swift-numerics/Sources/_NumericsShims/include/module.modulemap \
    -Xcc -I -Xcc ${PACKAGE_PATH}/.build/checkouts/swift-numerics/Sources/_NumericsShims/include \
    -Xcc -fmodule-map-file=${PACKAGE_PATH}/.build/checkouts/accelerate-linux/Sources/CLAPACK/module.modulemap \
    -I/usr/include/x86_64-linux-gnu \
    -Xcc -fmodule-map-file=${PACKAGE_PATH}/.build/checkouts/accelerate-linux/Sources/CBLAS/module.modulemap \
    -I/usr/include/x86_64-linux-gnu/openblas-pthread \
    -Xcc -fmodule-map-file=${PACKAGE_PATH}/.build/x86_64-unknown-linux-gnu/release/_MT19937.build/module.modulemap \
    -Xcc -I \
    -Xcc ${PACKAGE_PATH}/.build/checkouts/swift-ac-foundation/Sources/_MT19937/include \
    -Xcc -fmodule-map-file=${PACKAGE_PATH}/.build/x86_64-unknown-linux-gnu/release/_cxx.build/module.modulemap \
    -Xcc -I -Xcc ${PACKAGE_PATH}/.build/checkouts/swift-ac-foundation/Sources/_cxx/include \
    -Xcc -fmodule-map-file=${PACKAGE_PATH}/.build/x86_64-unknown-linux-gnu/release/_FastIO.build/module.modulemap \
    -Xcc -I -Xcc ${PACKAGE_PATH}/.build/checkouts/swift-ac-foundation/Sources/_FastIO/include \
    -module-cache-path ${PACKAGE_PATH}/.build/x86_64-unknown-linux-gnu/release/ModuleCache  \
...
swiftc \
    ...
    -lopenblas \
    -lstdc++ \
    -L ${PACKAGE_PATH}/.build/x86_64-unknown-linux-gnu/release \
    -o ${PACKAGE_PATH}/.build/x86_64-unknown-linux-gnu/release/Main \
    -module-name Main \
    -emit-executable \
    -Xlinker --gc-sections \
    -Xlinker --defsym \
    -Xlinker main=Main_main \
    -Xlinker '-rpath=$ORIGIN' \
    @${PACKAGE_PATH}/.build/x86_64-unknown-linux-gnu/release/Main.product/Objects.LinkFileList \
    -target x86_64-unknown-linux-gnu \
    -lm -g
EOF
