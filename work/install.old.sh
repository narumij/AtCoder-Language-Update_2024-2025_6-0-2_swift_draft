...
# 差分コンパイルの不具合にさらに見舞われたため、抽出したスクリプトを直接記述します
cat << 'EOF' > $SCRIPT_PATH
NUMBER="6.1.3"
VERSION="${NUMBER}-RELEASE"
PLATFORM="ubuntu24.04"
